package com.brittytino.patchwork.services.widgets
...
class BatteriesWidget : GlanceAppWidget() {
    ...
    override suspend fun provideGlance(context: Context, id: GlanceId) {
        provideContent {
            GlanceTheme {
                ...
                // Keys
                val KEY_AIRSYNC_ENABLED = androidx.datastore.preferences.core.booleanPreferencesKey(com.brittytino.patchwork.data.repository.SettingsRepository.KEY_AIRSYNC_CONNECTION_ENABLED)
                val KEY_MAC_LEVEL = androidx.datastore.preferences.core.intPreferencesKey(com.brittytino.patchwork.data.repository.SettingsRepository.KEY_MAC_BATTERY_LEVEL)
                val KEY_MAC_CONNECTED = androidx.datastore.preferences.core.booleanPreferencesKey(com.brittytino.patchwork.data.repository.SettingsRepository.KEY_AIRSYNC_MAC_CONNECTED)
                val KEY_SHOW_BLUETOOTH = androidx.datastore.preferences.core.booleanPreferencesKey(com.brittytino.patchwork.data.repository.SettingsRepository.KEY_SHOW_BLUETOOTH_DEVICES)
                val KEY_BLUETOOTH_BATTERY = androidx.datastore.preferences.core.stringPreferencesKey(com.brittytino.patchwork.data.repository.SettingsRepository.KEY_BLUETOOTH_DEVICES_BATTERY)
                ...
                val KEY_MAC_IS_CHARGING = androidx.datastore.preferences.core.booleanPreferencesKey(com.brittytino.patchwork.data.repository.SettingsRepository.KEY_MAC_BATTERY_IS_CHARGING)
                val macIsCharging = prefs[KEY_MAC_IS_CHARGING] ?: false

                val KEY_MAX_DEVICES = androidx.datastore.preferences.core.intPreferencesKey(com.brittytino.patchwork.data.repository.SettingsRepository.KEY_BATTERY_WIDGET_MAX_DEVICES)
                val maxDevices = prefs[KEY_MAX_DEVICES] ?: 8
                
                val KEY_BACKGROUND_ENABLED = androidx.datastore.preferences.core.booleanPreferencesKey(com.brittytino.patchwork.data.repository.SettingsRepository.KEY_BATTERY_WIDGET_BACKGROUND_ENABLED)
                ...
                if (hasBluetooth) {
                    try {
                        val type = object : com.google.gson.reflect.TypeToken<List<com.brittytino.patchwork.utils.BluetoothBatteryUtils.BluetoothDeviceBattery>>() {}.type
                        val devices: List<com.brittytino.patchwork.utils.BluetoothBatteryUtils.BluetoothDeviceBattery> = com.google.gson.Gson().fromJson(bluetoothJson, type) ?: emptyList()
    ...
    private fun BatteryItemBox(
        ...
        val bitmap = com.brittytino.patchwork.utils.BatteryRingDrawer.drawBatteryWidget(
