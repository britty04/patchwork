    ...
    suspend fun execute(context: Context, action: Action) {
        when (action) {
            ...
            is Action.DimWallpaper -> {
                com.brittytino.patchwork.utils.ShellUtils.runCommand(context, "cmd wallpaper set-dim-amount ${action.dimAmount}")
            }
                     ...
                     if (nm.isNotificationPolicyAccessGranted) {
                         try {
                              if (action.enabled) {
                                  ...
                                  val componentName = android.content.ComponentName(context, com.brittytino.patchwork.services.EssentialsConditionProvider::class.java)
                                  val conditionUri = com.brittytino.patchwork.services.EssentialsConditionProvider.CONDITION_URI
                                  ...
                                  val ruleBuilder = android.app.AutomaticZenRule.Builder("Essentials Focus", conditionUri)
                                      ...
                                      .setConfigurationActivity(android.content.ComponentName(context, com.brittytino.patchwork.MainActivity::class.java))
                                  ...
                                  com.brittytino.patchwork.services.EssentialsConditionProvider.setConditionState(context, true)
                                  ...
                                  com.brittytino.patchwork.services.EssentialsConditionProvider.setConditionState(context, false)
