...
class NotificationListener : NotificationListenerService() {
    ...
    private fun discoverSystemChannel(packageName: String, channelId: String?, userHandle: android.os.UserHandle) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            try {
                ...
                val type = object : com.google.gson.reflect.TypeToken<List<com.brittytino.patchwork.domain.model.SnoozeChannel>>() {}.type
                val discoveredChannels: MutableList<com.brittytino.patchwork.domain.model.SnoozeChannel> = if (discoveredJson != null) {
                ...
                if (discoveredChannels.none { it.id == channelId }) {
                    ...
                    discoveredChannels.add(com.brittytino.patchwork.domain.model.SnoozeChannel(channelId, finalName))
            ...
            if (enabled) {
                ...
                if (hasPermissions) {
                    ...
                    if (appSelected) {
                        ...
                        val styleName = prefs.getString("edge_lighting_style", com.brittytino.patchwork.domain.model.NotificationLightingStyle.STROKE.name)
    ...
    private fun isAppSelectedForNotificationLighting(packageName: String): Boolean {
        try {
            ...
            val gson = com.google.gson.Gson()
            val type = object : com.google.gson.reflect.TypeToken<List<com.brittytino.patchwork.domain.model.AppSelection>>() {}.type
            val selectedApps: List<com.brittytino.patchwork.domain.model.AppSelection> = gson.fromJson(json, type)
