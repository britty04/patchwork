...
import com.brittytino.patchwork.utils.OverlayHelper
...
class NotificationLightingService : Service() {
    ...
    private fun buildNotification(): Notification {
        val builder = NotificationCompat.Builder(this, CHANNEL_ID)
            .setSmallIcon(com.brittytino.patchwork.R.drawable.rounded_magnify_fullscreen_24)
            .setContentTitle("")
            .setContentText("")
            ...
            val color = when {
                ...
                colorMode == NotificationLightingColorMode.CUSTOM -> customColor
                    ...
                    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.S) {
                        ...
                        getColor(com.brittytino.patchwork.R.color.purple_500)
                    }
                }
            }
