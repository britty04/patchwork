...
class AirSyncBridgeReceiver : BroadcastReceiver() {
    override fun onReceive(context: Context, intent: Intent) {
        if (intent.action == "com.brittytino.patchwork.action.UPDATE_MAC_BATTERY") {
            ...
            if (repository.getBoolean(SettingsRepository.KEY_AIRSYNC_CONNECTION_ENABLED)) {
                ...
                kotlinx.coroutines.CoroutineScope(kotlinx.coroutines.Dispatchers.IO).launch {
                    try {
                         ...
                         val glanceIds = glanceAppWidgetManager.getGlanceIds(com.brittytino.patchwork.services.widgets.BatteriesWidget::class.java)
                         ...
                         glanceIds.forEach { glanceId ->
                            ...
                            com.brittytino.patchwork.services.widgets.BatteriesWidget().update(context, glanceId)
                        }
                    } catch (e: Exception) {
