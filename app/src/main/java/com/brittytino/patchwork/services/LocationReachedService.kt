...
import com.brittytino.patchwork.data.repository.LocationReachedRepository
import com.brittytino.patchwork.MainActivity
...
class LocationReachedService : Service() {
    ...
    companion object {
        ...
        private const val ACTION_STOP = "com.brittytino.patchwork.STOP_LOCATION_REACHED"
    ...
    private fun updateProgress(alarm: com.brittytino.patchwork.domain.model.LocationAlarm) {
    ...
    private fun triggerArrivalAlarm() {
        ...
        val fullScreenIntent = Intent(this, com.brittytino.patchwork.ui.activities.LocationAlarmActivity::class.java).apply {
