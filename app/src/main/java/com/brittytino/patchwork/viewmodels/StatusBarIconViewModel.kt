...
import com.brittytino.patchwork.domain.StatusBarIconRegistry
import com.brittytino.patchwork.ui.components.pickers.NetworkType
import com.brittytino.patchwork.utils.resetAllIconVisibilities
import com.brittytino.patchwork.utils.updateIconBlacklistSetting
...
class StatusBarIconViewModel : ViewModel() {
    ...
    private fun canWriteSecureSettings(context: Context): Boolean {
        return com.brittytino.patchwork.utils.PermissionUtils.canWriteSecureSettings(context)
    }
