...
class MainViewModel : ViewModel() {
    ...
    fun setDefaultTab(tab: com.brittytino.patchwork.domain.DIYTabs, context: Context) {
    ...
    fun freezeAllAuto(context: Context) {
        viewModelScope.launch(Dispatchers.IO) {
            com.brittytino.patchwork.utils.FreezeManager.freezeAll(context)
        }
    }

    fun unfreezeAllAuto(context: Context) {
        viewModelScope.launch(Dispatchers.IO) {
            com.brittytino.patchwork.utils.FreezeManager.unfreezeAll(context)
        }
    }

    fun freezeAllManual(context: Context) {
        viewModelScope.launch(Dispatchers.IO) {
            com.brittytino.patchwork.utils.FreezeManager.freezeAllManual(context)
        }
    }

    fun unfreezeAllManual(context: Context) {
        viewModelScope.launch(Dispatchers.IO) {
            com.brittytino.patchwork.utils.FreezeManager.unfreezeAllManual(context)
        }
    }
