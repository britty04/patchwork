...
class QSPreferencesActivity : ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (componentName != null) {
            ...
            if (componentName.className == "com.brittytino.patchwork.services.tiles.FlashlightTileService") {
            ...
            val feature = when (componentName.className) {
                "com.brittytino.patchwork.services.tiles.CaffeinateTileService" -> "Caffeinate"
                "com.brittytino.patchwork.services.tiles.NotificationLightingTileService" -> "Notification lighting"
                "com.brittytino.patchwork.services.tiles.DynamicNightLightTileService" -> "Dynamic night light"
                "com.brittytino.patchwork.services.tiles.AppLockTileService" -> "App lock"
                "com.brittytino.patchwork.services.tiles.ScreenLockedSecurityTileService" -> "Screen locked security"
                "com.brittytino.patchwork.services.tiles.AppFreezingTileService" -> "Freeze"
                "com.brittytino.patchwork.services.tiles.FlashlightPulseTileService" -> "Notification lighting"
                "com.brittytino.patchwork.services.tiles.StayAwakeTileService" -> "Quick settings tiles"
